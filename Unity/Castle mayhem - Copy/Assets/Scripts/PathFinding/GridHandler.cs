...
public class GridHandler : MonoBehaviour
{
    ...
    [SerializeField] int worldGridSize = 15;// = UnityEditor.EditorSnapSettings.move.x;
    ...
    {
        int x = Mathf.RoundToInt(position.x / worldGridSize);
        int y = Mathf.RoundToInt(position.z / worldGridSize);
